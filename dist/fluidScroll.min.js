...
window.fluidScroll = {
	...
	_init: function _init(opts) {
		...
		if (isBig === true && (fluidScroll._on === false || fluidScroll._on === null)) return fluidScroll._start(opts);else if (isSmall === true && (fluidScroll._on === true || fluidScroll._on === null)) return fluidScroll._stop(opts);
	},
