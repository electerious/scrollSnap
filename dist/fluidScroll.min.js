...
window.fluidScroll = {
	...
	init: function init() {
		...
		if (isBig === true && (fluidScroll._on === true || fluidScroll._on === null)) fluidScroll._start();else if (isSmall === true && (fluidScroll._on === true || fluidScroll._on === null)) fluidScroll._stop();
	...
	_onResize: function _onResize() {
		...
		fluidScroll._resizeTimer = setTimeout(function () {
			return fluidScroll.init(fluidScroll._computedOpts);
		}, 200);
	},
